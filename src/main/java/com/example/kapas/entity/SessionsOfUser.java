package com.example.kapas.entity;
...
@AllArgsConstructor
@Entity
@Table(name = "sessions_of_user")
public class SessionsOfUser implements Serializable {
    ...
    public SessionsOfUser(Integer userId, UserSession userSession) {
        this.userId = userId;
